...
//
// _coder_conjTrans_info.cpp
//
// Code generation for function 'conjTrans'
//

// Include files
#include "_coder_conjTrans_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("conjTrans"));
  ...
  emlrtSetField(xEntryPoints, 0, "FullPath",
                emlrtMxCreateString(
                    "C:\\Users\\kaley\\MATLAB\\Projects\\arm\\conjTrans.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739226.60297453706));
...
// End of code generation (_coder_conjTrans_info.cpp)
